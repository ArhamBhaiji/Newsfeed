 ...
 */
public class BBC implements PluginInterface, Callable<List<String>>{

    private final long updateFrequency = 1; //sets frequency to 1 minute
    private URL website = null;
    File file = new File("html/bbc.html"); //sets the file name for this plugin to download to
    Downloader downloader = new Downloader();;
    List headings = new  ArrayList();
    String url = "http://www.bbc.com/news"; //sets the url
    String pluginName = "BBC"; //sets the proper plugin name
    ...
    public List getHeadlines() {
        ...
        headings = downloader.parseFile("a.gs-c-promo-heading", file, url);
        return headings;
    }
